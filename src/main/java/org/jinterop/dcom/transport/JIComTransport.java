...
final class JIComTransport implements Transport
{
    ...
    /**
     * @see Transport#attach(PresentationSyntax)
     */
    ...
    public void close() throws IOException
    {
        try
        {
            if (channelWrapper != null)
            {
                if (JISystem.getLogger().isDebugEnabled())
                {
                    JISystem.getLogger().debug("Closing " + channelWrapper);
                }
    ...
    /**
     * @see Transport#receive(NdrBuffer)
     */
